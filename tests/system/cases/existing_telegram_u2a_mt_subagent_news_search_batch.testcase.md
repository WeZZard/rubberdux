...
## Storyline
<!-- The agent should be able to describe its running environment via Telegram when multiple user messages are batched -->
<!-- The agent should be able to spawn a subagent to search for news when user messages arrive in rapid succession -->
<!-- The agent should report the news results back to the user via Telegram after processing both requests -->
